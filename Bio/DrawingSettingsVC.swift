...
//protocol DrawingSettingsVC: class {
//  func settingsViewControllerFinished(_ drawingSettingsVC: DrawingSettingsVC)
//}

class DrawingSettingsVC: UIViewController {
