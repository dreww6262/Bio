//
//  ContentVenmoVC.swift
//  Bio
//
//  Created by Ann McDonough on 1/19/21.
...
class ContentVenmoVC: UIViewController, UIScrollViewDelegate {
    
    var venmoHex: HexagonStructData?
   ...
   // var captionTextField = UITextField()
    ...
    override func viewDidLoad() {
        ...
        newImageView = UIImageView(image: UIImage(named: "venmoCircle"))
