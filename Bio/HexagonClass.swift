...
//    
//    
//    init(text: String, type: String, time: TimeInterval, postingUserID: String, views: Int, thumbnail: UIImage, profilePicture: UIImage, location: Int, coordinateX: CGFloat, coordinateY: CGFloat, musicString: String, videoString:  String, isAnimated: Bool, documentID: String) {
//        self.text = text
//        self.type = type
//           self.time = time
...
//        let type = dictionary["type"] as! String? ?? "", typeThumbnail: UIImage(), isAnimated: false, contentString: "")
