...
var dictionary: [String: Any] {
    ...
    init(ava: String, type: String, currentUser: String, notifyingUser: String, thumbResource: String, createdAt: TimeInterval, checked: Bool, notificationID: String)  {
       self.ava = ava
       self.type = type
    ...
    let thumbResource = dictionary["thumbResource"] as! String? ?? ""
       let createdAt = dictionary["createdAt"] as! TimeInterval? ?? -1
