...
class NewBioSignInPage: UIViewController {
    ...
    @IBOutlet weak var moreOpportunitiesButton: UIButton!
    ...
    override func viewDidLoad() {
      ...
      //  label.text = "MANALOG"
        ...
        let hideTap = UITapGestureRecognizer(target: self, action: #selector(NewBioSignInPage.hideKeyboard(_:)))
